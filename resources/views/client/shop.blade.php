...
<main ng-app="myApp" ng-controller = "shop">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-4">
                        ...
                        <h5 class="pt-title">Nhập Sản Phẩm</h5>

                    <label for="searchInput" class="sr-only">Search</label>
                    <input type="text" class="form-control mb-20" ng-model="searchTerm"  placeholder="Tìm kiếm...">
                <!-- </div> -->
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="shop-banner mb-30">
                            <div class="banner-image">
                                <img class="banner-l" src="{{asset('images/sl-banner.jpg')}}" alt="">
                                <img class="banner-sm" src="{{asset('images/sl-banner-sm.png')}}" alt="">
                        ...
                        <div class="tab-content" id="productGridTabContent">
                            <div class="tab-pane fade  show active" id="FourCol" role="tabpanel" aria-labelledby="FourCol-tab">
                                ...
                                <div class="row g-0">
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6" ng-repeat="product in products | filter:searchTerm | filter:categoryFilter">
                <div class="product__item product__item-d">
                    <div class="product__thumb fix">
                        <div class="product-image w-img" style="width: 300px; height: 300px;">
                            <a href="product-details.html">
                            <img ng-src="/images/@{{ product.img_product }}" alt="product" id ="product-image" width="300px">
                            </a>
                        </div>
                    ...
                    <div class="product__add-cart-s text-center">
                        ...
                        <a href="/product-detail/@{{product.product_id}}"class="cart-btn d-flex mb-10 align-items-center justify-content-center w-100">Xem Ngay</a>
                    </div>
                        </div>
                            </div>
    ...
    <script src="{{ asset('client/thaotac/shop.js') }}"></script>
