...
<div class="main-content">
    ...
    <div class="form-group">
        ...
        <input type="text" id="simpleinput" class="form-control" placeholder="Nhập Tên Sản Phẩm" name="name_products" value="{{$product->name_products}}">
    </div>
    <div class="form-group">
    ...
    <!-- <button type="submit"class="btn btn-outline-info btn-lg btn-block" onclick="update_item('{{$product->id}}')">Cập Nhật</button> -->
                                        ...
                                        <button type="button" class="btn btn-danger" onclick="delete_product({{ $product->id }})">Xóa</button>
